...
/**
 * Resourceful controller for interacting with usertypes
 */
class UserTypeController {
  /**
   * Show a list of all usertypes.
   * GET usertypes
   *
   * @param {object} ctx
  ...
  /**
   * Render a form to be used for creating a new usertype.
